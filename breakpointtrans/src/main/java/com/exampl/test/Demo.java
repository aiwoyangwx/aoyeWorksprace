...
public class Demo {
    ...
    public static void main(String[] args) throws Exception{
        //请求服务器的路径
        String path="https://mirrors.aliyun.com/centos/7.6.1810/isos/x86_64/CentOS-7-x86_64-DVD-1810.iso";
        //构造URL地址
    ...
    public static class DownloadThread extends Thread{
         ...
         */
        public DownloadThread(String path, long threadId, long startIndex,
                              long endIndex) {
            this.path = path;
