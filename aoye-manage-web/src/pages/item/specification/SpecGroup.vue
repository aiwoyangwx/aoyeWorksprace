<template>
    <div>   
        ...
        <v-btn color='primary' @click="addGroup">新增客户端版本</v-btn>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "文件路径", value: "name", align: "center", sortable: false },
        { text: "版本名称", value: "name", align: "center", sortable: false },
        { text: "版本序号", value: "name", align: "center", sortable: false },
